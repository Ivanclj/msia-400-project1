...
full.inter.model <- lm(time_to_fill ~ norm.salary * region * safety * diploma * transportation * cust.serv + training * commercial * warehouse * quarter1 * quarter2 * quarter3, data = denver.driver)
