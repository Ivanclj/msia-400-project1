...
library(ggplot2)
# read in data
data_full <- read.csv('data_full.csv', stringsAsFactors = FALSE)
data_engineer <- read.csv('data_engineer.csv', stringsAsFactors = FALSE)
data_driver <- read.csv('data_driver.csv', stringsAsFactors = FALSE)
```
